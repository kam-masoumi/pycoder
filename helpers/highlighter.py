...
class Highlighter(QSyntaxHighlighter):
    def __init__(self, parent=None):
        ...
        colorScheme = ColorScheme().get(id=1)
        keywordsColor = colorScheme.keywords
        builtinColor = colorScheme.builtin
        commentColor = colorScheme.comment
        quotationColor = colorScheme.quotation
        functionColor = colorScheme.function
        decoratorColor = colorScheme.decorator

        keywordFormat = QTextCharFormat()
        keywordFormat.setForeground(QColor(keywordsColor))
        keywordFormat.setFontWeight(QFont.Bold)

        keywordPatterns = ["\\bclass\\b", "\\bdef\\b", "\\bfor\\b", "\\bdel\\b",
                           "\\bif\\b", "\\bin\\b", "\\bis\\b", "\\bnot\\b", "\\bglobal\\b",
                           ...
                           "\\blambda\\b", "\\bnonlocal\\b", "\\bor\\b", "\\band\\b"]
        ...
        functionFormat.setForeground(QColor(functionColor))
        ...
        builtinFormat.setForeground(QColor(builtinColor))
        ...
        singleLineCommentFormat.setForeground(QColor(commentColor))
        ...
        quotationFormat.setForeground(QColor(quotationColor))
        ...
        decoratorFormat.setForeground(QColor(decoratorColor))
